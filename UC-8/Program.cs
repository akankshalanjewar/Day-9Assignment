...
namespace UC_8
{
    public class Program
    {
        ...
        public static int ComputeEmp(string company, int NUM_OF_WORKING_DAYS, int MAX_HRS_IN_MONTH, int EMP_RATE_PER_HR)
        {
            ...
            Console.WriteLine(" total Emp for company: " + company + " totalEmpWages " + totalEmpWages);
